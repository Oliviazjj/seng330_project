...
/**
 * Repository class for <code>Contact</code> domain objects All method names are compliant with JPA naming
 */
public interface ContactRepository {
     ...
     *
     * @return a <code>Collection</code> of <code>Contact</code>s
     */

...
/**
 * Repository class for <code>EmployeeShift</code> domain objects All method names are compliant with JPA naming
 */
public interface EmployeeShiftRepository {
    ...
    List<EmployeeShift> findByEmployEventId(Integer employEventId);
